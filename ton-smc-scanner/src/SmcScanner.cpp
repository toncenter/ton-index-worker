...
void ShardStateScanner::start_up() {
    ...
    auto config_r = block::ConfigInfo::extract_config(mc_block_ds_.shard_blocks_[0].block_state, mc_block_ds_.shard_blocks_[0].block_data->block_id(), block::ConfigInfo::needCapabilities | block::ConfigInfo::needLibraries);
